...
flxTaskPRE = sub1PRE_EEG(flxStartSample_PRE:flxStopSample_PRE, 20);
extTaskPRE = sub1PRE_EEG(extStartSample_PRE:extStopSample_PRE, 20);
restTaskPRE = sub1PRE_EEG(restStartSample_PRE:restStopSample_PRE,20);
